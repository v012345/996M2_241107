...
local ShenLongHuanJing = {}
---------------网络消息----------------
function ShenLongHuanJing.Request(actor, var)
...
-------------网络消息↓↓↓--------------------------
Message.RegisterNetMsg(ssrNetMsgCfg.ShenLongHuanJing, ShenLongHuanJing)

return ShenLongHuanJing
