local FengDouHuanJing = {}
---------------网络消息----------------
function FengDouHuanJing.Request(actor, var)
...
-------------网络消息↓↓↓--------------------------
Message.RegisterNetMsg(ssrNetMsgCfg.FengDouHuanJing, FengDouHuanJing)

return FengDouHuanJing
