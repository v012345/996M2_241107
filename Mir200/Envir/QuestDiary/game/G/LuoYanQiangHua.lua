local LuoYanQiangHua = {}
LuoYanQiangHua.ID = "落岩强化"
local npcID = 818
--local config = include("QuestDiary/cfgcsv/cfg_LuoYanQiangHua.lua") --配置
local cost = { { "落岩元石", 20 }, { "造化结晶", 10 }, { "灵符", 400 } }
local give = { {} }
local mainName = "落岩强化"
local abilGroup = 3
--接收请求
function LuoYanQiangHua.Request(actor)
    ...
    local realAttrId1, realAttrId2 = 26, 213
    local attrId1, attrId2 = 89, 90
    ...
    LuoYanQiangHua.SyncResponse(actor)
end

--同步消息
function LuoYanQiangHua.SyncResponse(actor)
    local data = {}
    Message.sendmsg(actor, ssrNetMsgCfg.LuoYanQiangHua_SyncResponse, 0, 0, 0, data)
end
-- --登录触发
-- local function _onLoginEnd(actor, logindatas)
--     LuoYanQiangHua.SyncResponse(actor, logindatas)
-- end
-- --事件派发
-- GameEvent.add(EventCfg.onLoginEnd, _onLoginEnd, LuoYanQiangHua)
--注册网络消息
Message.RegisterNetMsg(ssrNetMsgCfg.LuoYanQiangHua, LuoYanQiangHua)
return LuoYanQiangHua
