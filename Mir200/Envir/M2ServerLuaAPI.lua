...
---*  monUserId: 怪物userid
---@param mapID string|integer
---@param monUserId string|integer
---@return string
...
---@param actor string 玩家对象
---@param attridx string 自定义属性组名称
---@param opt string 操作符 +、-、=
---@param attrStr string 属性字符串
---@param type integer 0=计算套装属性增加; 1=增加固定值;不计算套装属性(属性加成类无效) 2=全部属性计算完后 最后增加属性
